...
from .models import Course, NewCourse, Modality, ProfessorDescription, ProfessorNextPayment
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(ProfessorDescription, db.session))
    admin.add_view(ModelView(ProfessorNextPayment, db.session))
