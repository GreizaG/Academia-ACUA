...
Revision ID: 1b928736500f
Revises: 
Create Date: 2024-07-09 04:10:38.875164
...
def upgrade():
    ...
    sa.Column('number_cardID', sa.String(length=20), nullable=False),
    ...
    sa.Column('name', sa.String(length=50), nullable=False),
    sa.Column('cardID_type', sa.String(length=50), nullable=False),
    sa.Column('number_cardID', sa.BigInteger(), nullable=False),
    sa.Column('email', sa.String(length=50), nullable=False),
    sa.Column('phone_number', sa.BigInteger(), nullable=True),
    sa.Column('province', sa.String(length=50), nullable=True),
    sa.Column('canton', sa.String(length=50), nullable=True),
    ...
    op.create_table('professor_description',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('years_of_experience', sa.String(length=10), nullable=True),
    sa.Column('specialist_in', sa.String(length=80), nullable=True),
    sa.Column('studies', sa.String(length=30), nullable=True),
    sa.Column('professor_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['professor_id'], ['professor.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('professor_next_payment',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('date', sa.String(length=20), nullable=True),
    sa.Column('mount_per_hour', sa.String(length=30), nullable=True),
    sa.Column('registered_hours', sa.String(length=30), nullable=True),
    sa.Column('total_payment', sa.String(length=30), nullable=True),
    sa.Column('professor_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['professor_id'], ['professor.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    op.drop_table('professor_next_payment')
    op.drop_table('professor_description')
